...
var paths = {
  sass: ['./src/**/**/*.scss'],
  js: ['./src/app/**/**/*.js'],
  templates: ['./src/**/**/*.html', './src/**/**/*.json'],
  vendor: ['./vendor/**/*.js'],
  img : ['./src/assets/img/*'],
  json: ['./src/app/i18n/**/**/*.json']
};

var destFolder = './../public';

gulp.task('default', ['sass', 'js', 'vendor', 'templates', 'images', 'fonts', 'i18n']);
...
gulp.task('i18n', function(done) {
  ...
  .pipe(gulp.dest(destFolder+'/i18n/'))
  .pipe(connect.reload())
  .on('end', done);
});
